...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'oualid.amenzi@usmba.ac.ma',
  ...
  baseDirectory: process.env.BASE_DIRECTORY || '/ITSS Drive',
